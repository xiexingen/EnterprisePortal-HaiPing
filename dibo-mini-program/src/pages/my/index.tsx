...
class Index extends Component {
  ...
  getTaxInfo = async () => {
    const openid = await Taro.getStorageSync('openid');
    const res = await taxInfo({ tax_id: openid });
  ...
  render() {
    const { userData, taxData } = this.state;
    return (
      <View className="my">
        <View className="header">
          <View className="header_top">
            ...
            <View className="header_avatar" onClick={this.handleToUser}>
              <Image
                src={userData && userData.avatarUrl ? `${userData.avatarUrl}` : avatar}
                className="avatar"
              />
            </View>
        ...
        <View className="content">
          <View className="content-item">
            <View className="item">
              ...
              <View className="text-right">{/* <View className="text-number">16</View>  */}</View>
